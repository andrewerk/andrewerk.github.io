...
function Home () {
  return (
      <div className="min-h-screen bg-charcoal">
        ...
        <section className="text-gray-light font-bold bg-charcoal h-1/2 pr-40 pb-20 flex justify-between">
        ...
        <section className="text-4xl text-charcoal text-center font-bold bg-gray-light h-1/2 pt-16 pb-20 flex-col justify-between">
        ...
        <section className="text-4xl text-charcoal text-center font-bold bg-gray-light h-1/2 pt-16 pb-20 flex-col content-center">
